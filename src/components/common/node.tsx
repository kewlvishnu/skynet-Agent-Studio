...
export default function Node({
	...
	return (
		<div className="group relative w-86">
			<div
				className={`w-80 bg-theme border border-border rounded-lg py-4 flex flex-col gap-2 shadow-md hover:shadow-royal-blue-hover/50 transition-all duration-200`}
			>
				<div className="flex items-center justify-between px-4 pb-3 border-b border-border">
					<div className="flex items-center gap-3">
						<div
							className={`w-8 h-8 bg-primary rounded-lg flex items-center justify-center shadow-${color}`}
						>
					...
					<div className="flex items-center gap-2">
						<Button
							variant="ghost"
							size="icon"
							className={`text-muted-foreground hover:text-${color} z-20`}
						>
					...
					<div className="px-4 space-y-3">
						...
						<div className="space-y-1">
							...
							<Select value={data.responseType || "text"}>
								<SelectTrigger
									className={`bg-background/50 border border-border text-foreground focus:border-${color}`}
								>
